...
set_property(TARGET qt_DEPS_TARGET
             ...
             $<$<CONFIG:Release>:Qt6::Platform;xkbcommon::xkbcommon;xorg::xorg;opengl::opengl;Qt6::Core;xkbcommon::libxkbcommon-x11;Qt6::Gui;Qt6::XcbQpaPrivate;Qt6::Widgets;Qt6::OpenGL;Qt6::Svg>)
...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT Qt6::SvgWidgets #############

        set(qt_Qt6_SvgWidgets_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_SvgWidgets_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_SvgWidgets_FRAMEWORKS_RELEASE}" "${qt_Qt6_SvgWidgets_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_SvgWidgets_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_SvgWidgets_DEPS_TARGET)
            add_library(qt_Qt6_SvgWidgets_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_SvgWidgets_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_SvgWidgets_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_SvgWidgets_LIBS_RELEASE}"
                              "${qt_Qt6_SvgWidgets_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_SvgWidgets_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_SvgWidgets_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_SvgWidgets_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_SvgWidgets_DEPS_TARGET
                              qt_Qt6_SvgWidgets_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_SvgWidgets"
                              "${qt_Qt6_SvgWidgets_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::SvgWidgets
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_SvgWidgets_LIBS_RELEASE}" STREQUAL "")
        ...
        set_property(TARGET Qt6::SvgWidgets APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::SvgWidgets APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::SvgWidgets APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::SvgWidgets APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::SvgWidgets APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_SvgWidgets_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT Qt6::Svg #############
        ...
        set(qt_Qt6_Svg_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_Svg_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_Svg_FRAMEWORKS_RELEASE}" "${qt_Qt6_Svg_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_Svg_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_Svg_DEPS_TARGET)
            add_library(qt_Qt6_Svg_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_Svg_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_Svg_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_Svg_LIBS_RELEASE}"
                              "${qt_Qt6_Svg_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_Svg_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_Svg_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_Svg_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_Svg_DEPS_TARGET
                              qt_Qt6_Svg_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_Svg"
                              "${qt_Qt6_Svg_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::Svg
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_Svg_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt6::Svg
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt6::Svg APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::Svg APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::Svg APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::Svg APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::Svg APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_Svg_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT Qt6::QXcbIntegrationPlugin #############

        set(qt_Qt6_QXcbIntegrationPlugin_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_QXcbIntegrationPlugin_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_QXcbIntegrationPlugin_FRAMEWORKS_RELEASE}" "${qt_Qt6_QXcbIntegrationPlugin_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_QXcbIntegrationPlugin_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_QXcbIntegrationPlugin_DEPS_TARGET)
            add_library(qt_Qt6_QXcbIntegrationPlugin_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_QXcbIntegrationPlugin_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_QXcbIntegrationPlugin_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_QXcbIntegrationPlugin_LIBS_RELEASE}"
                              "${qt_Qt6_QXcbIntegrationPlugin_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_QXcbIntegrationPlugin_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_QXcbIntegrationPlugin_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_QXcbIntegrationPlugin_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_QXcbIntegrationPlugin_DEPS_TARGET
                              qt_Qt6_QXcbIntegrationPlugin_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_QXcbIntegrationPlugin"
                              "${qt_Qt6_QXcbIntegrationPlugin_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::QXcbIntegrationPlugin
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_QXcbIntegrationPlugin_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt6::QXcbIntegrationPlugin
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt6::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::QXcbIntegrationPlugin APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QXcbIntegrationPlugin_COMPILE_OPTIONS_RELEASE}>)


    ########## COMPONENT Qt6::QSvgPlugin #############

        set(qt_Qt6_QSvgPlugin_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_QSvgPlugin_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_QSvgPlugin_FRAMEWORKS_RELEASE}" "${qt_Qt6_QSvgPlugin_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_QSvgPlugin_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_QSvgPlugin_DEPS_TARGET)
            add_library(qt_Qt6_QSvgPlugin_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_QSvgPlugin_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_QSvgPlugin_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_QSvgPlugin_LIBS_RELEASE}"
                              "${qt_Qt6_QSvgPlugin_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_QSvgPlugin_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_QSvgPlugin_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_QSvgPlugin_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_QSvgPlugin_DEPS_TARGET
                              qt_Qt6_QSvgPlugin_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_QSvgPlugin"
                              "${qt_Qt6_QSvgPlugin_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::QSvgPlugin
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_QSvgPlugin_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt6::QSvgPlugin
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt6::QSvgPlugin APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::QSvgPlugin APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QSvgPlugin APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QSvgPlugin APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::QSvgPlugin APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgPlugin_COMPILE_OPTIONS_RELEASE}>)


    ########## COMPONENT Qt6::QSvgIconPlugin #############

        set(qt_Qt6_QSvgIconPlugin_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_QSvgIconPlugin_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_QSvgIconPlugin_FRAMEWORKS_RELEASE}" "${qt_Qt6_QSvgIconPlugin_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_QSvgIconPlugin_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_QSvgIconPlugin_DEPS_TARGET)
            add_library(qt_Qt6_QSvgIconPlugin_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_QSvgIconPlugin_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_QSvgIconPlugin_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_QSvgIconPlugin_LIBS_RELEASE}"
                              "${qt_Qt6_QSvgIconPlugin_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_QSvgIconPlugin_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_QSvgIconPlugin_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_QSvgIconPlugin_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_QSvgIconPlugin_DEPS_TARGET
                              qt_Qt6_QSvgIconPlugin_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_QSvgIconPlugin"
                              "${qt_Qt6_QSvgIconPlugin_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::QSvgIconPlugin
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_QSvgIconPlugin_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt6::QSvgIconPlugin
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt6::QSvgIconPlugin APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::QSvgIconPlugin APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QSvgIconPlugin APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::QSvgIconPlugin APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::QSvgIconPlugin APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_QSvgIconPlugin_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT Qt6::XcbQpaPrivate #############

        set(qt_Qt6_XcbQpaPrivate_FRAMEWORKS_FOUND_RELEASE "")
        conan_find_apple_frameworks(qt_Qt6_XcbQpaPrivate_FRAMEWORKS_FOUND_RELEASE "${qt_Qt6_XcbQpaPrivate_FRAMEWORKS_RELEASE}" "${qt_Qt6_XcbQpaPrivate_FRAMEWORK_DIRS_RELEASE}")

        set(qt_Qt6_XcbQpaPrivate_LIBRARIES_TARGETS "")

        ######## Create an interface target to contain all the dependencies (frameworks, system and conan deps)
        if(NOT TARGET qt_Qt6_XcbQpaPrivate_DEPS_TARGET)
            add_library(qt_Qt6_XcbQpaPrivate_DEPS_TARGET INTERFACE IMPORTED)
        endif()

        set_property(TARGET qt_Qt6_XcbQpaPrivate_DEPS_TARGET
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_FRAMEWORKS_FOUND_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_SYSTEM_LIBS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_DEPENDENCIES_RELEASE}>
                     )

        ####### Find the libraries declared in cpp_info.component["xxx"].libs,
        ####### create an IMPORTED target for each one and link the 'qt_Qt6_XcbQpaPrivate_DEPS_TARGET' to all of them
        conan_package_library_targets("${qt_Qt6_XcbQpaPrivate_LIBS_RELEASE}"
                              "${qt_Qt6_XcbQpaPrivate_LIB_DIRS_RELEASE}"
                              "${qt_Qt6_XcbQpaPrivate_BIN_DIRS_RELEASE}" # package_bindir
                              "${qt_Qt6_XcbQpaPrivate_LIBRARY_TYPE_RELEASE}"
                              "${qt_Qt6_XcbQpaPrivate_IS_HOST_WINDOWS_RELEASE}"
                              qt_Qt6_XcbQpaPrivate_DEPS_TARGET
                              qt_Qt6_XcbQpaPrivate_LIBRARIES_TARGETS
                              "_RELEASE"
                              "qt_Qt6_XcbQpaPrivate"
                              "${qt_Qt6_XcbQpaPrivate_NO_SONAME_MODE_RELEASE}")


        ########## TARGET PROPERTIES #####################################
        set_property(TARGET Qt6::XcbQpaPrivate
                     APPEND PROPERTY INTERFACE_LINK_LIBRARIES
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_OBJECTS_RELEASE}>
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_LIBRARIES_TARGETS}>
                     )

        if("${qt_Qt6_XcbQpaPrivate_LIBS_RELEASE}" STREQUAL "")
            # If the component is not declaring any "cpp_info.components['foo'].libs" the system, frameworks etc are not
            # linked to the imported targets and we need to do it to the global target
            set_property(TARGET Qt6::XcbQpaPrivate
                         APPEND PROPERTY INTERFACE_LINK_LIBRARIES
        ...
        set_property(TARGET Qt6::XcbQpaPrivate APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET Qt6::XcbQpaPrivate APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET Qt6::XcbQpaPrivate APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_LIB_DIRS_RELEASE}>)
        set_property(TARGET Qt6::XcbQpaPrivate APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET Qt6::XcbQpaPrivate APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${qt_Qt6_XcbQpaPrivate_COMPILE_OPTIONS_RELEASE}>)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::SvgWidgets)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::Svg)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::QXcbIntegrationPlugin)
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::QSvgPlugin)
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::QSvgIconPlugin)
    ...
    set_property(TARGET qt::qt APPEND PROPERTY INTERFACE_LINK_LIBRARIES Qt6::XcbQpaPrivate)
